            ...
            <div className="relative">
              <div className="text-center py-12 md:py-16 lg:py-20 px-4">
                <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-full shadow-2xl mb-6 md:mb-8 animate-fade-in-up">
                  ...
                  <span className="text-xs md:text-sm font-black tracking-widest">BUSINESS OVERVIEW</span>
                </div>
                
                <div className="animate-fade-in-scale">
                  <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black tracking-tighter leading-none mb-4 md:mb-6">
                ...
                <div className="flex justify-center pt-6 md:pt-8 animate-fade-in-up stagger-2">
                  <Button 
                    ...
                    className="btn-gradient text-white px-8 md:px-12 py-4 md:py-6 text-lg md:text-xl font-black tracking-widest hover-lift group"
                  >
                    <Plus className="h-5 w-5 md:h-6 md:w-6 mr-2 md:mr-3 group-hover:rotate-90 transition-transform" />
                    CREATE INVOICE
                  </Button>
                </div>
              </div>
                  ...
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-center justify-between mb-4 md:mb-6">
                      ...
                      {metric.title === "COLLECTION RATE" ? (
                        ...
                        <div className="text-right text-xs md:text-sm font-bold gradient-text">
                          {metric.trend}
                        </div>
                      )}
                    </div>
                    <div className="space-y-2 md:space-y-3">
                      ...
                      <p className="text-2xl md:text-3xl font-black gradient-text">{metric.value}</p>
                      {metric.title === "COLLECTION RATE" ? (
                        <Progress value={metric.trend as number} className="mt-3 h-2 md:h-3 bg-muted" />
                      ) : (
                ...
                <CardHeader className="border-b border-border pb-4 md:pb-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <CardTitle className="text-xl md:text-2xl font-black tracking-tight gradient-text">REVENUE TRENDS</CardTitle>
                        <CardDescription className="text-muted-foreground font-medium text-sm md:text-base">
                          Monthly performance overview
                        </CardDescription>
                      </div>
                    </div>
                    <TrendingUp className="h-5 w-5 md:h-6 md:w-6 text-indigo-500" />
                  </div>
                </CardHeader>
                <CardContent className="p-6 md:p-8">
                  <div className="h-64 md:h-80 flex items-end justify-between space-x-2 md:space-x-4 p-4 md:p-6">
                    {chartData.map((data, index) => (
                      <div key={data.month} className="flex flex-col items-center space-y-2 md:space-y-3 flex-1 group">
                        <div className="relative w-full">
                          ...
                          ></div>
                          <div className="absolute -top-8 md:-top-10 left-1/2 transform -translate-x-1/2 text-xs font-black gradient-text bg-background px-2 md:px-3 py-1 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
                            ${data.revenue}
                          </div>
                        </div>
                  ...
                  <div className="mt-6 md:mt-8 text-center">
                    <Button 
                      variant="outline" 
                      className="w-full border-2 border-indigo-200 text-indigo-700 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 hover:text-white hover:border-transparent font-bold tracking-wide transition-all duration-300"
                    >
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <Card className="neomorphism border-0 animate-fade-in-scale stagger-2">
                <CardHeader className="text-center pb-4">
                  <div className="mx-auto mb-4 p-3 md:p-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-2xl w-fit shadow-lg">
                    <Users className="h-6 w-6 md:h-8 md:w-8" />
                  </div>
                  <CardTitle className="text-lg md:text-xl font-black tracking-wide gradient-text">ACTIVE CLIENTS</CardTitle>
                </CardHeader>
                <CardContent className="text-center space-y-4">
                  ...
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="w-full border-2 border-indigo-200 text-indigo-700 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 hover:text-white hover:border-transparent font-bold"
                  >
                    MANAGE CLIENTS
                  </Button>
                </CardContent>
                ...
                <CardContent className="space-y-3">
                  {[
                    ...
                    <Button 
                      key={index}
                      variant="outline" 
                      className="w-full justify-start border-2 border-indigo-200 text-indigo-700 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 hover:text-white hover:border-transparent font-bold transition-all duration-300 text-sm md:text-base"
            ...
            <CardHeader className="border-b border-border pb-4 md:pb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="w-1 h-6 md:h-8 bg-gradient-to-b from-indigo-500 to-purple-500"></div>
                  <div>
                    <CardTitle className="text-xl md:text-2xl font-black tracking-tight gradient-text">RECENT INVOICES</CardTitle>
                    <CardDescription className="text-muted-foreground font-medium text-sm md:text-base">
